...
def worker(t, worker_model, counter, params):
    ...
    for i in range(params['epochs']):
        ...
        initial_percept = worker_env.init(0.2, False, True)
...
if __name__ == '__main__':
    ...
    MasterNode.load_state_dict(torch.load('wumpusworld_ac3 20K episodes x 12 workers max 50000 steps with wumpus no pits no exit.pth'))
    ...
    path = f'wumpusworld_ac3 with pits no exit {params.epochs} episodes max {params.max_steps} steps {params.n_workers} workers.pth'
